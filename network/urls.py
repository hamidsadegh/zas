...
urlpatterns = [
    ...
    path("discovery/scan/<uuid:job_id>/status/", discovery_scan_status, name="discovery_scan_status"),
    path("discovery/scan/<uuid:job_id>/results/", discovery_scan_results, name="discovery_scan_results"),
